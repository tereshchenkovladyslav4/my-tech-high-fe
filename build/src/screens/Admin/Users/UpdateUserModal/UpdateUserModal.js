...
import {Button, Checkbox, CircularProgress, FormControlLabel, FormGroup, Grid, IconButton, Modal, TextField} from "../../../../../_snowpack/pkg/@mui/material.js";
...
import {updateUserMutation} from "../../../../graphql/mutation/user.js";
...
import {getUser, getUsersByRegions} from "../../../../graphql/queries/user.js";
...
export const UpdateUserModal = ({
  ...
  const {loading: userLoading, error: userError, data: currentUserData} = useQuery(getUser, {
    variables: {
      user_id: userID
    },
    fetchPolicy: "cache-and-network"
  });
  const [updateUser, {data: responseData, loading: uploading, error: uploadingError}] = useMutation(updateUserMutation);
  useEffect(() => {
    if (!userLoading && currentUserData !== void 0) {
      ...
      if (!userLoading) {
        if (userError?.networkError || userError?.graphQLErrors?.length > 0 || userError?.clientErrors.length > 0) {
          setApolloError({
            title: userError?.clientErrors[0]?.message || userError?.graphQLErrors[0]?.message || userError?.networkError?.message,
            severity: "Error",
            flag: true
          });
        }
    ...
    switch (userLevel) {
      ...
      case "Teacher Assistant":
        form = /* @__PURE__ */ React.createElement(Grid, {
          ...
          placeholder: "Select State",
          setParentValue: (value) => setSelectedState(Number(value))
        }), selectedState && /* @__PURE__ */ React.createElement(Box, null, /* @__PURE__ */ React.createElement(DropDown, {
          size: "small",
  ...
  }), userLoading ? /* @__PURE__ */ React.createElement(Box, {
    display: "flex",
    flexDirection: "row",
    justifyContent: "center",
    alignItems: "center"
  }, /* @__PURE__ */ React.createElement(CircularProgress, null)) : /* @__PURE__ */ React.createElement(Fragment, null, /* @__PURE__ */ React.createElement(Box, {
    sx: classes.header
