...
My Tech High`,
  values: [
    ...
    },
    {
      ...
      checked: false,
      extraText: "State law requires that students entering 6 the grade be fully immunized or submit a Personal Exemption form that was issued in 2022. Please provide an exemption form that was issued this year.",
      abbr: "sgim"
    },
    {
...
export const AGE_ISSUE_OPTIONS = {
  type: "AGE_ISSUE",
  default: `Hi <PARENT>,
