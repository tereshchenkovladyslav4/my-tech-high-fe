...
export const submitEnrollmentMutation = gql`
  mutation SaveEnrollmentPacketSubmission($enrollmentPacketDocumentInput: EnrollmentPacketSubmissionInput!) {
    saveEnrollmentPacketSubmission(enrollmentPacketDocumentInput: $enrollmentPacketDocumentInput) {
      packet {
        packet_id
      }
      student {
