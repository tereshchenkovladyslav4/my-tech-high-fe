              ...
              <Box key={i}>
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    {!isAddStudent ? (
                      ...
                      <Checkbox
                        checked={newQuestion.student_question}
                        onClick={() =>
                          setQuestionValue(
                            newQuestion.id,
                            newQuestion.slug,
                            'student_question',
                            newQuestion.student_question ? false : true,
                          )
                        }
                      />
                    )}
                    ...
                    <Checkbox
                      ...
                      onClick={() => {
                        setQuestionValue(
                          ...
                          newQuestion.slug,
                          'required',
                          newQuestion.required ? false : true,
                        )
                      }}
                    />
                ...
                >
                  <DropDown
                    sx={{
                      pointerEvents:
                        newQuestion.default_question && newQuestion.type !== QUESTION_TYPE.TEXTFIELD ? 'none' : 'unset',
                      minWidth: '200px',
                      [`& .${outlinedInputClasses.root}.${outlinedInputClasses.focused} .${outlinedInputClasses.notchedOutline}`]:
                        {
                          borderColor: MthColor.SYSTEM_07,
