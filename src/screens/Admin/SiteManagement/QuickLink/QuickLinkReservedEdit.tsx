...
const QuickLinkReservedEdit: React.FC<{quickLink: QuickLink, updateQuickLinks: (quickLink: QuickLink) => void, backAction: () => void, backToEdit: () => void}> = ({quickLink, updateQuickLinks, backAction, backToEdit}) => {
