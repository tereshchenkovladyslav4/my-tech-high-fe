...
import { BLUE_GRDIENT, GREEN_GRADIENT, RED_GRADIENT, YELLOW_GRADIENT } from '../../../../utils/constants'
...
export const EmailRecordsTable = () => {
    const { me } = useContext(UserContext);
    const [filters, setFilters] = useState(['Error']);
    const [recordCount, setRecordCount] = useState({Error: 4, Sent: 1})
