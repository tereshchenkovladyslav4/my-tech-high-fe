...
import { Button, Checkbox, CircularProgress, FormControlLabel, FormGroup, Grid, IconButton, Modal, TextField } from '@mui/material';
...
export const UpdateUserModal: UpdateModalTemplateType = ({
	handleModem,
	userID,
	visible
}) => {
