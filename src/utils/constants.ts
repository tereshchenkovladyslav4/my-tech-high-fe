  ...
  Applications: [
    {
      ...
      template: 'standard',
      inserts: ['parent', 'student', 'year', 'deadline'],
    },
    {
    ...
    { title: 'Application Page', template: 'standard', inserts: ['parent', 'student', 'year'] },
  ],
  // 'Direct Orders': ['Approval', 'Order Confirmation'],
  // 'Email Verification': ['Batch Send Out', 'Email Change', 'New Application'],
  'Enrollment Packets': [
    { title: 'Packet Accepted', template: 'standard', inserts: ['parent', 'student', 'year', 'deadline'] },
    {
      title: 'Missing Information',
      template: 'update',
      inserts: ['parent', 'student', 'year', 'link', 'files', 'instructions'],
    },
    {
      title: 'Packet Reminders',
      template: 'deadline',
      inserts: ['parent', 'student', 'year', 'deadline', 'link'],
    },
    {
      title: 'Age Issue',
      template: 'standard_response',
      inserts: ['parent', 'student', 'year'],
    },
    {
