...
export const ENROLLMENT_PACKETS = `${ENROLLMENT}-packets`
...
export const emailTemplates = {
  ...
  Users: [
    { title: 'Email Verification', template: 'standard' },
    { title: 'Forgot Password', template: 'standard' },
    { title: 'Email Changed', template: 'standard' },
  ],
  Applications: [
    {
      title: 'Application Received',
      template: 'standard',
      inserts: ['parent', 'student', 'application_year', 'deadline'],
    },
    {
    ...
    { title: 'Application Page', template: 'standard', inserts: ['parent', 'student', 'application_year'] },
  ],
  // 'Direct Orders': ['Approval', 'Order Confirmation'],
  // 'Email Verification': ['Batch Send Out', 'Email Change', 'New Application'],
  'Enrollment Packets': [
    { title: 'Packet Accepted', template: 'standard', inserts: ['parent', 'student', 'application_year', 'deadline'] },
    {
      title: 'Missing Information',
      template: 'update',
      inserts: ['parent', 'student', 'application_year', 'link', 'files', 'instructions'],
    },
    {
      title: 'Packet Reminders',
      template: 'deadline',
      inserts: ['parent', 'student', 'application_year', 'deadline', 'link'],
    },
    {
      title: 'Enrollment Packet Page',
      template: 'standard',
      inserts: ['parent', 'student', 'application_year'],
    },
  ],
  // Homeroom: ['Learning Log Reminder'],
  // Interventions: ['First Notice', 'Missing Log', 'Max Ex', 'Exceed Ex'],
  // 'Learning Logs': ['Missing Learning Log'],
  // Miscellaneous: ['Email Change', 'Red Email Button'],
  // Packets: ['Accepted', 'Missing Info', 'Auto Reminder', '2nd Auto Reminder', 'Manual Reminder'],
  // 'Re-enroll': ['Intento Re-enroll Notification', 'Intent to Re-enroll Reminder'],
  // 'Re-enrollment': ['Re-enrollment Information', 'Re-enrollment Packet Acceptance', 'Immunization Information'],
  ...
  //   'Not Started',
  //   'Change',
  //   '2nd Semester Reminder...',
  // ],
  // Withdrawals: ['Confirmation', 'Withdrawal'],
}
